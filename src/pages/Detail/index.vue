        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(skuSaleAttr, index) in skuSaleAttrList"
                :key="skuSaleAttr.id"
              >
                ...
                <dd
                  ...
                  :key="attrValue.id"
                  @click="changeAttr(attrValue, skuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="goodsNum" @change="inputGoodsNum"/>
...
export default {
  ...
  computed: {
    ...mapGetters("detail", ["categoryView", "skuInfo", "skuSaleAttrList"]),
    skuImageList() {
      return this.skuInfo.skuImageList || [];
    },
  },
  methods: {
    changeAttr(attrValue, arr) {
      arr.forEach(item=>{
        item.isChecked = 0;
      });
    ...
    async addShopCart() {
      try {
        await this.$store.dispatch('detail/addToCart', {goodsId:this.$route.params.goodsId, 'goodsNum':this.goodsNum});
        // TODO 路由跳转
